...
class Home : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val lowEndChart = findViewById<LineChart>(R.id.low_end_chart_last)
        val midEndChart = findViewById<LineChart>(R.id.mid_end_chart_last)
        val highEndChart = findViewById<LineChart>(R.id.high_end_chart_last)
        ...
        RetrofitClient.getApiService(this).getPredictions().enqueue(object :
